...
echo openstack network create --internal  --provider-network-type vxlan cf-vpn-network-internal-$NUM_3
openstack network create --internal  --provider-network-type vxlan cf-vpn-network-internal-$NUM_3
...
echo openstack subnet create cf-vpn-internal-subnet-$SUBNET_IP_PREFIX$NUM_3-24 --ip-version 4 --subnet-range $SUBNET_IP_PREFIX$NUM_3.0/24 --allocation-pool start=$SUBNET_IP_PREFIX$NUM_3.1,end=$SUBNET_IP_PREFIX$NUM_3.253 --gateway $SUBNET_IP_PREFIX$NUM_3.254 --network $NET_ID_3 --no-dhcp
openstack subnet create cf-vpn-internal-subnet-$SUBNET_IP_PREFIX$NUM_3-24 --ip-version 4 --subnet-range $SUBNET_IP_PREFIX$NUM_3.0/24 --allocation-pool start=$SUBNET_IP_PREFIX$NUM_3.1,end=$SUBNET_IP_PREFIX$NUM_3.253 --gateway $SUBNET_IP_PREFIX$NUM_3.254 --network $NET_ID_3 --no-dhcp
...
echo openstack router create cf-vpn-router-$NUM_3 --centralized
openstack router create cf-vpn-router-$NUM_3 --centralized
...
openstack router add subnet $ROUTER_ID_3 $SUBNET_ID_3
echo openstack router add subnet $ROUTER_ID_3 $SUBNET_ID_3
...
echo neutron router-gateway-set $ROUTER_ID_3 "${EXTERNAL_NETWORK_ID}" 
neutron router-gateway-set $ROUTER_ID_3 "${EXTERNAL_NETWORK_ID}" 
...
echo openstack port create cf-vpn-port-$SUBNET_IP_PREFIX$NUM_3-1 --fixed-ip subnet=$SUBNT_ID_3,ip-address=$SUBNET_IP_PREFIX$NUM_3.1 --network $NET_ID_3
openstack port create cf-vpn-port-$SUBNET_IP_PREFIX$NUM_3-1 --fixed-ip subnet=$SUBNT_ID_3,ip-address=$SUBNET_IP_PREFIX$NUM_3.1 --network $NET_ID_3
...
echo openstack server create --port $PORT_ID_3 --image $IMAGE_ID --flavor $FLAVOR_ID cf-vpn-vm-$NUM_3
openstack server create --port $PORT_ID_3 --image $IMAGE_ID --flavor $FLAVOR_ID cf-vpn-vm-$NUM_3
...
echo neutron vpn-endpoint-group-create --type cidr --value "0.0.0.0/0" --name cf-local-cidr-endpoint-cidr-$NUM_2
neutron vpn-endpoint-group-create --type cidr --value "0.0.0.0/0" --name cf-local-cidr-endpoint-cidr-$NUM_2
echo neutron vpn-endpoint-group-create --type subnet --value $SUBNET_ID_3 --name cf-local-subnet-endpoint-subnet-$NUM_3
neutron vpn-endpoint-group-create --type subnet --value $SUBNET_ID_3 --name cf-local-subnet-endpoint-subnet-$NUM_3
echo neutron vpn-endpoint-group-create --type subnet --value $SUBNET_ID_2 --value $SUBNET_ID_1 --name cf-local-subnet-endpoint-subnet-$NUM_2-$NUM_1
neutron vpn-endpoint-group-create --type subnet --value $SUBNET_ID_2 --value $SUBNET_ID_1 --name cf-local-subnet-endpoint-subnet-$NUM_2-$NUM_1
echo neutron vpn-endpoint-group-create --type subnet --value $SUBNET_ID_2 --value $SUBNET_ID_3 --name cf-local-subnet-endpoint-subnet-$NUM_2-$NUM_3
neutron vpn-endpoint-group-create --type subnet --value $SUBNET_ID_2 --value $SUBNET_ID_3 --name cf-local-subnet-endpoint-subnet-$NUM_2-$NUM_3
# peer cidr
echo neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_1.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_1
neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_1.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_1
echo neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_2.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_2
neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_2.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_2
echo neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_3.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_3
neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_3.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_3
echo neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_2.0/24 --value $SUBNET_IP_PREFIX$NUM_1.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_2-$NUM_1
neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_2.0/24 --value $SUBNET_IP_PREFIX$NUM_1.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_2-$NUM_1
echo neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_2.0/24 --value $SUBNET_IP_PREFIX$NUM_3.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_2-$NUM_3
neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_2.0/24 --value $SUBNET_IP_PREFIX$NUM_3.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_2-$NUM_3
...
LOCAL_SUBNET_ENDPOINT_GROUP_2_1=$(get_args_id_value "neutron vpn-endpoint-group-list" "cf-local-subnet-endpoint-subnet-$NUM_2-$NUM_1")
LOCAL_SUBNET_ENDPOINT_GROUP_2_3=$(get_args_id_value "neutron vpn-endpoint-group-list" "cf-local-subnet-endpoint-subnet-$NUM_2-$NUM_3")
...
PEER_CIDR_ENDPOINT_GROUP_2_1=$(get_args_id_value "neutron vpn-endpoint-group-list" "cf-peer-cidr-endpoint-cidr-$NUM_2-$NUM_1")
PEER_CIDR_ENDPOINT_GROUP_2_3=$(get_args_id_value "neutron vpn-endpoint-group-list" "cf-peer-cidr-endpoint-cidr-$NUM_2-$NUM_3")
...
echo neutron vpn-ikepolicy-create --auth-algorithm $AUTH_ALGORITHM --encryption-algorithm $ENCRYPTION_ALGORITHM --ike-version $IKE_VERSION cf-ikepolicy-$NUM_3
neutron vpn-ikepolicy-create --auth-algorithm $AUTH_ALGORITHM --encryption-algorithm $ENCRYPTION_ALGORITHM --ike-version $IKE_VERSION cf-ikepolicy-$NUM_3
...
echo neutron vpn-ipsecpolicy-create --auth-algorithm $AUTH_ALGORITHM --encryption-algorithm $ENCRYPTION_ALGORITHM cf-ipsecpolicy-$NUM_3
neutron vpn-ipsecpolicy-create --auth-algorithm $AUTH_ALGORITHM --encryption-algorithm $ENCRYPTION_ALGORITHM cf-ipsecpolicy-$NUM_3
...
echo neutron vpn-service-create $ROUTER_ID_3 --name cf-vpn-service-$NUM_3
neutron vpn-service-create $ROUTER_ID_3 --name cf-vpn-service-$NUM_3
