...
echo openstack network create --internal  --provider-network-type vxlan cf-vpn-network-internal-$NUM_4
openstack network create --internal  --provider-network-type vxlan cf-vpn-network-internal-$NUM_4
...
echo openstack subnet create cf-vpn-internal-subnet-$SUBNET_IP_PREFIX$NUM_3-24 --ip-version 4 --subnet-range $SUBNET_IP_PREFIX$NUM_3.0/24 --allocation-pool start=$SUBNET_IP_PREFIX$NUM_3.1,end=$SUBNET_IP_PREFIX$NUM_3.253 --gateway $SUBNET_IP_PREFIX$NUM_3.254 --network $NET_ID_1 --no-dhcp
...
echo openstack subnet create cf-vpn-internal-subnet-$SUBNET_IP_PREFIX$NUM_4-24 --ip-version 4 --subnet-range $SUBNET_IP_PREFIX$NUM_4.0/24 --allocation-pool start=$SUBNET_IP_PREFIX$NUM_4.1,end=$SUBNET_IP_PREFIX$NUM_4.253 --gateway $SUBNET_IP_PREFIX$NUM_4.254 --network $NET_ID_2 --no-dhcp
openstack subnet create cf-vpn-internal-subnet-$SUBNET_IP_PREFIX$NUM_4-24 --ip-version 4 --subnet-range $SUBNET_IP_PREFIX$NUM_4.0/24 --allocation-pool start=$SUBNET_IP_PREFIX$NUM_4.1,end=$SUBNET_IP_PREFIX$NUM_4.253 --gateway $SUBNET_IP_PREFIX$NUM_4.254 --network $NET_ID_4 --no-dhcp
...
echo openstack router add subnet $ROUTER_ID_2 $SUBNET_ID_3
openstack router add subnet $ROUTER_ID_2 $SUBNET_ID_3
echo openstack router add subnet $ROUTER_ID_2 $SUBNET_ID_4
openstack router add subnet $ROUTER_ID_2 $SUBNET_ID_4
...
echo openstack port create cf-vpn-port-$SUBNET_IP_PREFIX$NUM_4-1 --fixed-ip subnet=$SUBNT_ID_4,ip-address=$SUBNET_IP_PREFIX$NUM_4.1 --network $NET_ID_4
openstack port create cf-vpn-port-$SUBNET_IP_PREFIX$NUM_4-1 --fixed-ip subnet=$SUBNT_ID_4,ip-address=$SUBNET_IP_PREFIX$NUM_4.1 --network $NET_ID_4
...
echo openstack server create --port $PORT_ID_4 --image $IMAGE_ID --flavor $FLAVOR_ID cf-vpn-vm-$NUM_4
openstack server create --port $PORT_ID_4 --image $IMAGE_ID --flavor $FLAVOR_ID cf-vpn-vm-$NUM_4
...
echo neutron vpn-endpoint-group-create --type subnet --value $SUBNET_ID_3 --value $SUBNET_ID_4  --name cf-local-subnet-endpoint-subnet-$NUM_3-$NUM_4
neutron vpn-endpoint-group-create --type subnet --value $SUBNET_ID_3 --value $SUBNET_ID_4  --name cf-local-subnet-endpoint-subnet-$NUM_3-$NUM_4
# peer cidr
echo neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_1.0/24 --value $SUBNET_IP_PREFIX$NUM_2.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_1-$NUM_2
neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_1.0/24 --value $SUBNET_IP_PREFIX$NUM_2.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_1-$NUM_2 
echo neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_3.0/24 --value $SUBNET_IP_PREFIX$NUM_4.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_3-$NUM_4
neutron vpn-endpoint-group-create --type cidr --value $SUBNET_IP_PREFIX$NUM_3.0/24 --value $SUBNET_IP_PREFIX$NUM_4.0/24 --name cf-peer-cidr-endpoint-cidr-$NUM_3-$NUM_4
